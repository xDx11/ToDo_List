 ...
 */
public class NotesAdapterPerDay extends ArrayAdapter<Note> {


    public NotesAdapterPerDay(Context context, int resource, List<Note> objects) {
    ...
    public View getView(int position, View convertView, ViewGroup group){
        ...
        if (convertView == null) {
            ...
            convertView = inflator.inflate(R.layout.list_item_note_detail, null);
        }
        ...
        TextView textDescription = (TextView) convertView.findViewById(R.id.textViewDesctiption);
